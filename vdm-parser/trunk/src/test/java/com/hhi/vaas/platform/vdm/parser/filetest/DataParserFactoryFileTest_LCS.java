...
public class DataParserFactoryFileTest_LCS {
	...
	public static void main(String args[]) {
		// init mapping stream
		InputStream mappingXmlStream = DataParserFactoryFileTest_LCS.class.getResourceAsStream(TestResources.TEST_MAP_LCS_FILE);
		...
		InputStream kvStream = DataParserFactoryFileTest_LCS.class.getResourceAsStream(TestResources.TEST_KV_LCS_FILE);
		DataInputStream dis = new DataInputStream(kvStream);
		...
		assertNotNull("invalid resources : nmea stream", kvStream);
