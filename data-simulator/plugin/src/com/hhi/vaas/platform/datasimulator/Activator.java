...
public class Activator extends AbstractUIPlugin {
	...
	public void start(BundleContext context) throws Exception {
		...
		LOGGER.setLogger(LOGGER.getLogger().getLogger(Activator.class.getName()));
		LOGGER.getLogger().info("Starting Activator.");
	}
	...
	public static ImageDescriptor getImageDescriptor(String path) {
		return imageDescriptorFromPlugin(IDefineID.PLUGIN_ID, path);
	}
}
